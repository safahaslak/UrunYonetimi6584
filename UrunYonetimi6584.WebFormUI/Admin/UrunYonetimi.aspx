...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>Marka</td>
        <td><asp:TextBox ID="txtBrand" CssClass="form-control" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Stok</td>
        <td><asp:TextBox ID="txtStock" TextMode="Number" required CssClass="form-control" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Fiyat</td>
        <td><asp:TextBox ID="txtPrice" required CssClass="form-control" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Kategori</td>
        <td>
    ...
    <tr>
        ...
        <td><asp:TextBox ID="txtDescription" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Durum</td>
        <td><asp:CheckBox ID="cbIsActive" CssClass="form-check" Text="Durum" runat="server"/></td>
    </tr>
    <tr>
        <td>Ürün Resmi</td>
        <td>
